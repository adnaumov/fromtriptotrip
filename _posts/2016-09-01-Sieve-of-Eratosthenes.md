...
keywords: "education, Sieve of Eratosthenes, prime"
categories: [Education]
tags: [education, Sieve of Eratosthenes, prime]
icon: fa-plane
---
...
<body>
    ...
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th>KPn</th>
                <th>KPn+1</th>
                <th>Простые числа в диапазоне от KPn до KPn+1</th>
            </tr>
        </thead>
        <tbody id="TableBody">
        </tbody>
    ...
    <script>
        ...
        var prime2 = [];
        var checkList = [];
        sieve(+prompt('Введите max(Pn+1)', '100'), +prompt('Введите коэффициент K', '2'));
    </script>
